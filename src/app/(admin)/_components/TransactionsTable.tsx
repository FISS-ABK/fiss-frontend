              ...
              {transactions.map((transaction) => {
                ...
                >
                  <td className="px-4 py-3 sm:px-0 sm:py-4">
                    <div className="flex items-center gap-2 sm:gap-3">
                      <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-gray-700 text-xs font-medium text-white sm:h-10 sm:w-10 sm:text-sm">
                        {transaction.fullName[0]}
                      </div>
                      <div className="min-w-0">
                        <p className="truncate font-medium text-gray-900">{transaction.fullName}</p>
                  ...
                  <td className="hidden whitespace-nowrap px-4 py-3 text-gray-600 lg:table-cell lg:px-0 lg:py-4">
                    {formatDate(transaction.date ?? transaction.created_at ?? transaction.updated_at)}
                  </td>
