...
export default function Footer() {
  ...
  return (
    <footer className="mt-auto bg-[#edf5f5] relative overflow-hidden">
      
      {/* --- CREATIVE BACKGROUND WATERMARK --- */}
      {/* This sits behind everything. Faint, large, and slightly rotated. */}
      <div className="absolute inset-0 z-0 flex items-center justify-center pointer-events-none overflow-hidden">
        <div className="relative w-[800px] h-[800px] opacity-[0.03] rotate-12">
          <Image
      ...
      {/* Main Footer Content (Z-10 keeps it clickable) */}
      <div className="relative z-10 px-4 py-8 sm:px-6 sm:py-10 md:py-12 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 gap-8 rounded-xl bg-white/80 backdrop-blur-sm p-5 sm:grid-cols-2 sm:rounded-2xl sm:p-6 md:gap-10 lg:grid-cols-4 lg:gap-12 lg:p-8 shadow-sm">
            {/* Logo */}
            ...
            <div className="text-center sm:text-left">
              ...
              <div>
                ...
                <p className="font-suisse text-sm text-[#0a1628]">
                  Beside Muda Lawal Stadium, Asero
                  <br />
                  Abeokuta, Ogun State.
                </p>
              </div>
      ...
      {/* Mission Statement */}
      <div className="relative z-10 px-4 py-6 sm:px-6 sm:py-8 md:py-10 lg:px-8 lg:py-12">
        <div className="mx-auto max-w-7xl">
      ...
      {/* Copyright Bar */}
      <div className="relative z-10 border-t border-gray-200 px-4 py-4 sm:px-6 lg:px-8 bg-[#edf5f5]/80 backdrop-blur-sm">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 text-center sm:flex-row sm:gap-0 sm:text-left">
          ...
          <sub className="order-last text-xs text-gray-500 sm:order-0 sm:text-sm">
            Built by
            <Link href={"https://x.com/mhetHQ"} className="hover:underline font-semibold text-[#0B2C4D]">
              {" "} mhetLabs
            </Link>
          </sub>
          <Link
